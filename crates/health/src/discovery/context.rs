...
impl CollectorKind {
    ...
    pub(super) fn stop_message(self) -> &'static str {
        match self {
            ...
            CollectorKind::NvueRest => "Stopping NVUE REST collector for removed switch endpoint",
            CollectorKind::NvueGnmi => "Stopping NVUE gNMI collector for removed switch endpoint",
        }
    }
}
