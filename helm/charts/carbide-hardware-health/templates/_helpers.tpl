...
*/}}
{{- define "carbide-hardware-health.namespace" -}}
...
*/}}
{{- define "carbide-hardware-health.name" -}}
...
*/}}
{{- define "carbide-hardware-health.chart" -}}
...
Common labels
*/}}
{{- define "carbide-hardware-health.labels" -}}
helm.sh/chart: {{ include "carbide-hardware-health.chart" . }}
...
Selector labels
*/}}
{{- define "carbide-hardware-health.selectorLabels" -}}
app.kubernetes.io/name: carbide-hardware-health
app.kubernetes.io/component: hardware-health
{{- end }}
...
*/}}
{{- define "carbide-hardware-health.image" -}}
...
*/}}
{{- define "carbide-hardware-health.serviceMonitorSpec" -}}
endpoints:
  - honorLabels: false
